...
/*!******************************************!*\
  !*** ./src/app/services/case.service.ts ***!
  \******************************************/
/*! exports provided: CaseType, CaseService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var CaseService = /** @class */ (function () {
     ...
     */
    function CaseService(http, userService) {
        this.http = http;
    ...
    CaseService.prototype.userId = function () {
        this.userService.getUserId();
    };
    CaseService.prototype.userInfo = function () {
    ...
    * @param {CaseType} type movie, series, episode or empty
    * @returns Observable with the search results
    */
    CaseService.prototype.searchData = function (title, type) {
        return this.http.get(this.url + "?s=" + encodeURI(title) + "&type=" + type + "&apikey=" + this.apiKey).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (results) { return results['Search']; }));
    };
    CaseService.prototype.me = function () {
        var _this = this;
        return this.http.post(this.url + "/me", {})
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (_) { return _this.userService.log('fetched books'); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.userService.handleError('getBooks', [])));
    };
    CaseService.prototype.mapCases = function (data) {
        ...
        var participants = [];
        // return this.getCaseParticipants(data.id);
        // .subscribe((item: any) => {
        //   return item;
        //   // return {
        //   //   ...data,
        ...
        //   // }
        // });
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, data, { statusText: statusText,
            statusColor: statusColor, lastAssignee: 'Paul Lieberman', callStatus: statusText, callStatusColor: statusText === 'Accepted' ? 'primary' : 'warning', from: 'CuraCall Message', participants: participants });
    };
    CaseService.prototype.getCases = function (param) {
        var _this = this;
        return this.http.get(this.url + "/case", { params: param })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (_) { return _this.userService.log('fetched books'); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.userService.handleError('getBooks', [])));
    };
    CaseService.prototype.getCase = function (caseId, userId) {
        return this.http.get(this.url + "/case/" + caseId + "?user_id=" + userId);
    };
    CaseService.prototype.getCaseCount = function (userId) {
        return this.http.get(this.url + "/case-counter/" + userId);
    };
    CaseService.prototype.getCaseParticipants = function (caseId) {
        return this.http.get(this.url + "/case-participants?case_id=" + caseId);
    };
    CaseService.prototype.casePreview = function (caseId) {
        return this.http.get(this.url + "/case-preview/" + caseId + "/" + this.userService.getUserId());
    };
    CaseService.prototype.acceptCase = function (case_id, user_id) {
        return this.http.post(this.url + "/case-to-accept", { case_id: case_id, user_id: user_id });
    };
    CaseService.prototype.closeCase = function (params) {
        return this.http.post(this.url + "/case-close", params);
    };
    CaseService.prototype.caseReopen = function (params) {
        return this.http.post(this.url + "/case-reopen", params);
    };
    CaseService.prototype.addNote = function (params) {
        return this.http.post(this.url + "/case-note/" + params.id, params);
    };
    CaseService.prototype.forwardCase = function (params) {
        return this.http.post(this.url + "/case-forward", params);
    };
    CaseService.prototype.readCase = function (params) {
        return this.http.post(this.url + "/case-read/" + params.id, { params: params });
    };
...
var DataService = /** @class */ (function () {
    function DataService() {
        this.messageSource = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"]('1');
...
var MessageService = /** @class */ (function () {
    ...
    MessageService.prototype.userId = function () {
        this.userService.getUserId();
    };
    MessageService.prototype.userInfo = function () {
        return JSON.parse(localStorage.getItem('user'));
    };
    MessageService.prototype.getMessages = function () {
        return this.http.get(this.url + "/messages");
    };
    MessageService.prototype.getUnreadCount = function () {
        return this.http.get(this.url + "/message/room/unread");
    };
    MessageService.prototype.getCheckIfIsRead = function (param) {
        return this.http.get(this.url + "/message/room/isread", { params: param });
    };
    MessageService.prototype.getRecentContacts = function (param) {
        return this.http.get(this.url + "/message/recent", param);
    };
    MessageService.prototype.deleteAllMessages = function (param) {
        return this.http.post(this.url + "/message/delete/all", param);
    };
    MessageService.prototype.createRoom = function (param) {
        return this.http.post(this.url + "/message/create/room", param);
    };
    MessageService.prototype.updatePusherRoomId = function (param) {
        return this.http.post(this.url + "/message/update/roompusher", param);
    };
    MessageService.prototype.getConversations = function (id) {
        return this.http.get(this.url + "/messages/" + id);
    };
    MessageService.prototype.storeConversations = function (param) {
        return this.http.post(this.url + "/messages", param);
    };
    ...
    MessageService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _user_service__WEBPACK_IMPORTED_MODULE_4__["UserService"]])
    ], MessageService);
